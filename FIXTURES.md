...
[
    {
        "plugin": "aprfc-qte-01h",
        "url": null,
        "local_source": "fixtures/aprfc-qte-01h/20241123_akurma.t21z.2dvaranl_ndfd_3p0.grb2",
        "versioned": false,
...
[
    {
        ...
        "local_source": "fixtures/aprfc-qpf-06h/qpf06f_has_NNNf_YYYYMMDD_HH_awips_202510140703_2025101418f006.3339381911.grb.gz",
        "versioned": true,
        "name_pattern": "qpf06f_has_NNNf_YYYYMMDD_HH_awips_%Y%m%d%H%M_%Y%m%d_%Hf*.grb.gz"
    }
]
```
...
[
    {
        "plugin": "prism-ppt-early",
        "url": "",
        "local_source": "fixtures/prism-ppt-early/prism_ppt_us_25m_20251103.zip",
        "versioned": false,
        "name_pattern": "prism_ppt_us_25m_%Y%m%d.zip"
    }
]
```
...
[
    {
        "plugin": "nohrsc-snodas-assimilated",
        "url": "",
        "local_source": "fixtures/nohrsc-snodas-assimilated/assim_layers_2022010112.tar",
        "versioned": false,
...
[
    {
        "plugin": "mbrfc-krf-qpe-01h",
        "url": "",
        "local_source": "fixtures/mbrfc-krf-qpe-01h/krfqpe_2022080921z.grib.gz",
        "versioned": false,
...
[
    {
        "plugin": "marfc-fmat-06h",
        "url": "",
        "local_source": "fixtures/marfc-fmat-06h/FMAT12hr_20220601.00z.grb",
        "versioned": true,
    ...
    },
    {
        "plugin": "marfc-fmat-06h",
        "url": "",
        "local_source": "fixtures/marfc-fmat-06h/FMAT12hr_20220601.06z.grb",
        "versioned": true,
        "name_pattern": "FMAT12hr_%Y%m%d.00z.grb"
    },
    {
        "plugin": "marfc-fmat-06h",
        "url": "",
        "local_source": "fixtures/marfc-fmat-06h/FMAT12hr_20220601.12z.grb",
        "versioned": true,
        "name_pattern": "FMAT12hr_%Y%m%d.00z.grb"
    },
    {
        "plugin": "marfc-fmat-06h",
        "url": "",
        "local_source": "fixtures/marfc-fmat-06h/FMAT12hr_20220601.18z.grb",
        "versioned": true,
        "name_pattern": "FMAT12hr_%Y%m%d.00z.grb"
    }
]
...
[
    {
        "plugin": "prism-tmin-early",
        "url": "",
        "local_source": "fixtures/prism-tmin-early/prism_tmin_us_25m_20251103.zip",
        "versioned": false,
        "name_pattern": "prism_tmin_us_25m_%Y%m%d.zip"
    }
]
```
...
[
    {
        "plugin": "ncrfc-mpe-01h",
        "url": "",
        "local_source": "fixtures/ncrfc-mpe-01h/MSR_mpe-lx_2022080922z.grb",
        "versioned": false,
...
[
    {
        "plugin": "nwrfc-qpf-06h",
        "url": "",
        "local_source": "fixtures/nwrfc-qpf-06h/QPF.2022121212.nc.gz",
        "versioned": true,
...
[
    {
        "plugin": "hrrr-total-precip",
        "url": "",
        "local_source": "fixtures/hrrr-total-precip/hrrr.t00z.wrfsfcf00.grib2",
        "versioned": true,
        "products": 0,
    ...
    },
    {
        "plugin": "hrrr-total-precip",
        "url": "",
        "local_source": "fixtures/hrrr-total-precip/hrrr.t00z.wrfsfcf06.grib2",
        "versioned": true,
...
[
    {
        "plugin": "prism-tmax-early",
        "url": "",
        "local_source": "fixtures/prism-tmax-early/prism_tmax_us_25m_20251103.zip",
        "versioned": false,
        "name_pattern": "prism_tmax_us_25m_%Y%m%d.zip"
    }
]
```
...
[
    {
        "plugin": "abrfc-qpe-01h",
        "url": "",
        "local_source": "fixtures/abrfc-qpe-01h/abrfc_qpe_01hr_2025102413Z.nc.gz",
        "versioned": false,
        "name_pattern": "abrfc_qpe_01hr_%Y%m%d%HZ.nc.gz"
    }
]
```
...
[
    {
        "plugin": "aprfc-qtf-01h",
        "url": "https://cbt.crohms.org/akgrids",
        "local_source": "fixtures/aprfc-qtf-01h/ta01f_has_NNNf_YYYYMMDD_HH_awips_202510131109_2025102312f240.grb.gz",
        "versioned": true,
        "name_pattern": "ta01f_has_NNNf_YYYYMMDD_HH_awips_%Y%m%d%H%M_%Y%m%d_%Hf*.grb.gz"
    }
]
```
